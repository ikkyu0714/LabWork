...
#iden = '逵�1.v.0310'   #lemma---------antonyms()
#iden = '鬪ｯ鬮�.v.0101'  #facet---------antonyms() + senses

#iden = '荳榊刈.d.0100'  #--------------hypernyms() + senses
#iden = '蜍ｿ.d.0200'    #--------------hyponyms()
#iden = '莉｣1.n.0810'   #--------------holonyms()
#iden = '譛昜ｻ｣.n.0100'  #--------------meronyms()
...
class Synset(object):
    ...
    def __init__(self,iden='譛昜ｻ｣.n.0100'):
...
class Sense(object):
    ...
    def __init__(self, iden='譎ｨ髢�.n.0100'):
        ####################################      NAME     ##################
        lemmaName = iden[:-7]#逕ｨregex謚雁ｾ碁擇謨ｸ蟄怜悉謗�?How?
        self.name = lemmaName
        ...
        self.pinyin = sound_key[0][0]#.encode('utf8') #蜉�荳榊刈?
        #print self.pinyin
...
class Facet(object):
    ...
    def __init__(self, iden='蝟�.v.0201'):
        ####################################      NAME     ##################
        lemmaName = iden[:-7]#逕ｨregex謚雁ｾ碁擇謨ｸ蟄怜悉謗�?How?
        self.name = lemmaName
...
def synsets(userInput):
    ...
    for a in sense_id:
        ...
        if len(pos_tag) == 0:
            ...
            POS.append(pos_tag[0][0][0].lower()) # 邊苓ｩ樣｡�
    #print 'POS=', POS
